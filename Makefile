...
flash:
	...
	@bash -c "[ -f firmware.bin ] && esptool.py --port /dev/ttyUSB0 --baud 460800 write_flash --flash_size=detect 0 firmware.bin && sleep 5"

repl:
	@bash -c "mpfshell --open ttyUSB0"
